...
//        KoneksiDB.sambungDB();
    ...
    private void simpanData() {
        ...
        if (kode.isEmpty() || nama.isEmpty() || kategori.equals("") || lokasi.isEmpty() || deskripsi.isEmpty()
            ...
            String kategoria = cmbkategori.getSelectedItem().toString();
            String sql
    ...
    private void initComponents() {
        ...
        panelKiri.setBackground(new java.awt.Color(153, 255, 153));
        ...
        tblarsip.setBackground(new java.awt.Color(153, 255, 153));
